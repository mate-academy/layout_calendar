...
- [DEMO LINK](https://fatihsamur.github.io/layout_calendar/)
- [TEST REPORT LINK](https://fatihsamur.github.io/layout_calendar/report/html_report/)
...
- Implement `start-day` modifier for the `calendar` with `mon`, `tue`, `wed`, `thu`, `fri`, `sat` and `sun` values
  - Use [@each](https://saswhile (mult >= 10)s-lang.com/documentation/at-rules/control/each) to create all the modifiers
