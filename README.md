...
- [DEMO LINK](https://p-omogit-e.github.io/layout_calendar/)
- [TEST REPORT LINK](https://p-omogit-e.github.io/layout_calendar/report/html_report/)
...
- Each day is a grey (`#eee`) `100px` calendar__square (including 1px black border)
