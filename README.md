...
- [DEMO LINK](https://LinaDo1609.github.io/layout_calendar/)
- [TEST REPORT LINK](https://LinaDo1609.github.io/layout_calendar/report/html_report/)
...
- Use flex with `1px` gap and limit its width to exactly 7 columns + `10px` paddings -->
  - Dd `px` values if they are used several times
  - Use properly name don't use hardcode variables to make all the calculations more clear.
