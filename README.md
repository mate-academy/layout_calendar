...
- [DEMO LINK](https://partnersinbahamas.github.io/layout_calendar/)
- [TEST REPORT LINK](https://partnersinbahamas.github.io/layout_calendar/report/html_report/)
...
- Implement `` modifier for the `calendar` with `mon`, `tue`, `wed`, `thu`, `fri`, `sat` and `sun` values
