...
- [DEMO LINK](https://Hladkyi03.github.io/layout_calendar/)
- [TEST REPORT LINK](https://Hladkyi03.github.io/layout_calendar/report/html_report/)
...
- Each day is a grey (`#eee`) `100px` square (including 1px black border)
  - Add a number (`Arial 30px`) in the center of each day using `::before` and [@for](https://sassz-lang.com/documentation/at-rules/control/for)
